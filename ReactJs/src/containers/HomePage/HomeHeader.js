                ...
                <div className='home-header-container'>
                    <div className='home-header-content'>
                        ...
                        <div className='right-content'>
                            ...
                            <div className={language === LANGUAGES.VI ? "language-vi active" : 'language-vi'}><span onClick={() => this.changeLanguagge(LANGUAGES.VI)}>VN</span></div>
                            <div className={language === LANGUAGES.EN ? "language-en active" : 'language-en'}><span onClick={() => this.changeLanguagge(LANGUAGES.EN)}>EN</span></div>
                        </div>
                    </div>
                </div>
